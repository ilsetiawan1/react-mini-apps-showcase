...
const CalcKeypad = () => {
  ...
  const btnStyle = 'col-span-3 ascpect-square roundend-full shadow-md flex items-center justify-center text-xl'
  ...
  return (
    <div className="rounded-lg p-4 mt-4 shadow-[0_0_10px_rgba(0,0,0,0.3)] w-full">
      <div className="grid grid-cols-12 gap-4">
        ...
        {/* Clear All */}
        <button onClick={() => clearAll()} className="col-span-6 h-10 rounded-full shadow-[0_0_10px_rgba(0,0,0,0.3)]">
          AC
        </button>
        {/* Result */}
        <button onClick={() => result()} className="col-span-6 h-10 rounded-full shadow-[0_0_10px_rgba(0,0,0,0.3)]">
          =
        </button>
      </div>
    </div>
