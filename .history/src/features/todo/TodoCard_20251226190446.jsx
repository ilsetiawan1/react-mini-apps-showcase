...
const TodoCard = () => {
  const { posts, deletePost, handleEditMode } = usePostContext();
          ...
          <ul key={post.id} className="shadow-xl/30 p-4 rounded-lg ">
            <li>
              ...
              <div className="flex gap-3">
                {/* Button Update */}
                <button onClick={() => handleEditMode} className="bg-linear-to-r from-sky-600 to-slate-500 px-4 py-2 text-xs text-white rounded-md grow">
                  Update
                </button>
