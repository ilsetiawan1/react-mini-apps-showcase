...
const TodoInput = () => {
  ...
  return (
    <form onSubmit={handleAddPosts}>
      ...
      {/* Input title*/}
      <input 
      type="text" id="myInput" name="title" onChange={handleInputChange} className="bg-slate-200 border-2 rounded-md" />


      {/* Input content*/}
      <textarea name="content" id="" onChange={handleInputChange} className="bg-slate-200 border-2 rounded-md"></textarea>
      {/* button */}
