...
const Hero = () => {
  return (
    <section className="bg-linear-to-br from-teal-500 to-slate-800 text-white px-4 py-12 md:p-16 rounded-3xl shadow-2xl mb-12 transform hover:scale-[1.01] transition duration-500">
      {/* Slogan Utama */}
