...
const Header = () => {
  return (
    <nav className="w-full  text-white shadow-lg sticky top-0 z-10 px-4">
      <div className="max-w-7xl mx-auto px-8 flex justify-between items-center py-4 bg-blue-950 rounded-lg">
        {' '}
        {/* Logo */}
