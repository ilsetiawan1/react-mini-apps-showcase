...
const Header = () => {
  ...
  return (
    <nav
      className={`w-full sticky py-4 top-0 z-50 transition-all duration-300
        ${scrolled ? 'bg-white/70 backdrop-blur-xl shadow-md text-slate-900' : 'bg-linear-to-r from-teal-600 to-slate-800 text-white'}
      `}
    >
