  ...
  return (
    <div className="rounded-lg p-4 shadow-[0_0_10px_rgba(0,0,0,0.3)] w-full">
      <div className="grid grid-cols-12 gap-4">
        ...
        <button onClick={() => handleButtonClick('c')} className="col-span-6 h-15 bg-red-300 rounded-full shadow-[0_0_10px_rgba(0,0,0,0.3)]">
          c
        </button>
        ...
        {/* Result */}
        <button onClick={() => handleButtonClick('e')} className="col-span-12 h-10 rounded-full shadow-[0_0_10px_rgba(0,0,0,0.3)]">
          =
        </button>
      </div>
    </div>
