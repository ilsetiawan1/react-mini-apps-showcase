...
const Dashboard = () => {
  return (
    <div className="px bg-gradient-to-br from-teal-600 to-salte-300 text-white p-12 md:p-16 rounded-3xl shadow-2xl mb-12 transform hover:scale-[1.01] transition duration-500">
      {/* Slogan Utama */}
