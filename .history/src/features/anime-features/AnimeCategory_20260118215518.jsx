...
const navCategory = ({ isActive }) =>
  `px-4 py-2 rounded-lg transition-all text-sm sm:text-xl lg:text-xl font-medium ${isActive ? 'bg-slate-800 text-white shadow-md' : 'text-slate-600 hover:bg-slate-200'}`;
