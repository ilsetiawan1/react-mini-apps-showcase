...
const Header = () => {
  return (
    <nav className="w-full  shadow-lg sticky top-0 z-10 py-4">
      <div className="max-w-7xl mx-auto px-4 flex justify-between items-center py-4 bg-linear-65 from-teal-600 to-slate-300 rounded-xl text-yellow-800">
        {' '}
        {/* Logo */}
