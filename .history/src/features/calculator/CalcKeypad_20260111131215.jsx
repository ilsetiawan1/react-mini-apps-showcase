...
const CalcKeypad = () => {
  ...
  const btnBase = 'col-span-3 bg-white';
  ...
  return (
    <div className="w-full mt-6">
      <div className="grid grid-cols-12 gap-3">
        ...
        <button onClick={deleteClick} className={''}>
          DEL
        </button>
        ...
        {/* Baris 2 */}
        <button onClick={() => handleButtonClick('7')} className={''}>
          7
        </button>
        ...
        <button onClick={() => handleButtonClick('x')} className={''}>
          ×
        </button>
