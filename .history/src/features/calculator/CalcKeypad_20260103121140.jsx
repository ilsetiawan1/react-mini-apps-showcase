...
const CalcKeypad = () => {
  const { handleButtonClick, deleteClick } = useCalcContext();
  ...
  return (
    <div className="rounded-lg p-4 mt-4 shadow-[0_0_10px_rgba(0,0,0,0.3)] w-full">
      <div className="grid grid-cols-12 gap-4">
        ...
        {/* Result */}
        <button onClick={() => handleButtonClick('=')} className="col-span-12 h-10 rounded-full shadow-[0_0_10px_rgba(0,0,0,0.3)]">
          =
        </button>
      </div>
    </div>
