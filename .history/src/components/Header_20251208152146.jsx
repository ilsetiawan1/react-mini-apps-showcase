...
const Header = () => {
  ...
  return (
    <nav
      className={`w-full sticky top-4 mb-14 rounded-xl z-50 transition-all duration-300
        ${scrolled ? 'bg-white/20 backdrop-blur-xl shadow-md text-slate-900' : 'bg-linear-to-r from-teal-600 to-slate-800 text-white'}
      `}
    >
