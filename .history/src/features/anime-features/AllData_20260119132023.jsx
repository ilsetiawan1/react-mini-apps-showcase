            ...
            >
              <div className="flex flex-col justify-center items-center">
                <div className="overflow-hidden aspect-3/4">
                  <img src={item.images.jpg.image_url} alt={item.title} className="rounded-sm h-full w-full object-cover transition-transform duration-200 group-hover:scale-105" />
                </div>
