...
const TodoUpdate = () => {
  const { editInput, handleUpdateChange, cancelEdit, handleSaveUpdate } = usePostContext();
  ...
  return (
    <form onSubmit={handleSaveUpdate}>
      ...
      <div className="flex flex-col gap-3">
        ...
        <button onCanPlay={() => cancelEdit()} className="bg-linear-to-r from-teal-600 to-slate-800 px-4 py-2 text-white rounded-md">
          Cancel
        </button>
      </div>
    </form>
